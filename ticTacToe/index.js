...
chekWin = () => {
    ...
    let wins = [
        [0, 1, 2 , 5 ,4.5 , 0, 8 ,11.5 , 0],
        [3, 4, 5 , 5 ,14.5, 0, 8 , 41.5 , 0],
        [6, 7, 8 , 5 ,24.5, 0 , 8 , 71.5, 0],
        [0, 3, 6 , -5,15, 90 , -20 , 42.5 ,90],
        [1, 4, 7 , 5 ,15, 90 , 10, 42.5 , 90],
        [2, 5, 8 , 15,15, 90 , 41 ,42.5 ,90],
        [0, 4, 8 , 5 ,15, 45 , 10, 42.5 , 45],
        [2, 4, 6 , 5 ,15,135 ,10 ,42.5 , 135]
